...
**折扣／クーポン割引**：如果折扣明顯是針對緊接在前面的某個商品（收據上最常見的
形式），AI 會直接把折扣扣進那個商品的金額，不會另外多跑一行「折扣」——這樣才不會
漏算，也不用你自己記得把折扣那行的分攤對象跟商品對齊。只有真的是整單、跟特定商品
無關的折扣（例如會員折扣、滿額折扣），才會保留成獨立的一行，這種折扣預設用「全部
套用」的分攤名單，你可以再自己調整。
